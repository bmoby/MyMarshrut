class AnnoncesController < ApplicationController
  ...
  def mesannonces
    @mesannonces = current_user.annonces
  end
  ...
  private
    ...
    def annonce_params
      ...
      :nombre_place, :emails, :telephones, :marque_vehicule, :annee_vehicule, :prix_passager, :poid_max_passager,
      :accept_colis, :accept_colis_valeur, :prix_kg_colis, :poid_max_colis, :poid_min_colis, :arrets_chaque, 
      :description, :itiniraire, :image)
